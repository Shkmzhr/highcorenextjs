         ...
         <div className="flex flex-col items-center justify-between lg:flex-row py-16">
             <div className=" relative ">
                 <div className=" absolute top-0 -left-48 z-0  opacity-50 ">
                     <Image src="https://img.freepik.com/free-vector/abstract-halftone-sphere-vector-background_1017-13977.jpg?t=st=1709632187~exp=1709635787~hmac=a6db8ff908cfe1687ea8cf716b0aeeec30c49b9c654930178089eb442a6161ee&w=740" className="w-36 z-0  h-full object-fill fill-y text-y " width='144' height={100} alt='image'/>
                 </div>
                 <div className="lg:max-w-xl lg:pr-5 relative z-40" style={{
          ...
          transition: "all 0.9s cubic-bezier(0.17, 0.55, 0.55, 1) 0.5s"
                     ...
                     <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                         We make you look
                         <span className="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash color-changing-text">
  different
</span>                     </h2>
                     <p className="text-base text-gray-700">Welcome to the world of Innovation; Be the change, Experience the Innovation</p>
                     <div className="mt-10 flex flex-col items-center md:flex-row">
                         <a href="/" className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-gray-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                             View More</a>
             ...
             <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
                 ...
                 <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                      <Image src="https://img.freepik.com/free-photo/modern-business-building-scenery-touching-sky_181624-5785.jpg?w=360&t=st=1709632085~exp=1709632685~hmac=4c785ce5bd15c61e4b04ff29da23baafb0ad0f1c9d289ee5757eaccfaafef1ae" alt='imageforwebsite' height={400} width={400} layout="intrinsic" />
                 </div>
             </div>
         </div>
     </div> 
