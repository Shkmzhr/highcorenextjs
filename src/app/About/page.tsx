         ...
         <div className="flex flex-col items-center justify-between lg:flex-row py-16">
             <div className=" relative ">
                 <div className=" absolute top-0 -left-48 z-0  opacity-50 ">
                     <img src="https://img.freepik.com/free-vector/abstract-halftone-sphere-vector-background_1017-13977.jpg?t=st=1709632187~exp=1709635787~hmac=a6db8ff908cfe1687ea8cf716b0aeeec30c49b9c654930178089eb442a6161ee&w=740" className="w-36 z-0  h-full    object-fill fill-y text-y   "/>
                 </div>
             ...
             <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
                 ...
                 <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                      <img src="https://img.freepik.com/free-photo/modern-business-building-scenery-touching-sky_181624-5785.jpg?w=360&t=st=1709632085~exp=1709632685~hmac=4c785ce5bd15c61e4b04ff29da23baafb0ad0f1c9d289ee5757eaccfaafef1ae"/>
                 </div>
             </div>
         </div>
     </div> 
